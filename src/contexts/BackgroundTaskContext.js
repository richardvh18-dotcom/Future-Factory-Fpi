...
export const BackgroundTaskProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        const q = query(collection(db, 'future-factory/exports/tasks'), where('userId', '==', currentUser.uid), orderBy('createdAt', 'desc'), limit(10));
    ...
    return (_jsx(BackgroundTaskContext.Provider, { value: { tasks, downloadTaskResult }, children: children }));
};
