...
const RoadmapViewer = () => {
    ...
    return (_jsxs("div", { className: "p-8 max-w-4xl mx-auto space-y-8", children: [_jsxs("div", { className: "flex space-x-6 border-b border-slate-200 pb-1", children: [_jsx("button", { onClick: () => setActiveTab("roadmap"), className: `pb-3 px-2 font-bold text-sm uppercase tracking-widest transition-colors ${activeTab === "roadmap" ? "text-blue-600 border-b-2 border-blue-600" : "text-slate-400 hover:text-slate-600"}`, children: "\uD83D\uDE80 Master Roadmap" }), _jsx("button", { onClick: () => setActiveTab("pilot"), className: `pb-3 px-2 font-bold text-sm uppercase tracking-widest transition-colors ${activeTab === "pilot" ? "text-blue-600 border-b-2 border-blue-600" : "text-slate-400 hover:text-slate-600"}`, children: "\uD83D\uDEE0\uFE0F Fittings Pilot (BH18 & BM01)" })] }), activeTab === "roadmap" && (_jsxs(_Fragment, { children: [_jsxs("div", { children: [_jsxs("h2", { className: "text-3xl font-bold text-slate-900 mb-2", children: ["\uD83D\uDE80 ", t('roadmap.title', "Master Roadmap")] }), _jsx("p", { className: "text-slate-600", children: t('roadmap.subtitle', "Volg de projectontwikkeling") })] }), _jsx("div", { className: "space-y-3", children: phases.map((phase) => (_jsxs("div", { className: "border-2 border-slate-200 rounded-lg p-4", children: [_jsxs("button", { onClick: () => setExpandedPhase(expandedPhase === phase.id ? null : phase.id), className: "w-full flex items-center justify-between", children: [_jsx("div", { children: _jsx("h3", { className: "font-bold text-left", children: t('roadmap.phase', { id: phase.id, title: phase.title }) }) }), _jsxs("div", { className: "flex items-center gap-4", children: [_jsx("span", { className: "text-sm", children: phase.status }), expandedPhase === phase.id ? _jsx(ChevronDown, { size: 20 }) : _jsx(ChevronRight, { size: 20 })] })] }), expandedPhase === phase.id && (_jsx("div", { className: "mt-4 space-y-2 border-t pt-4", children: phase.items.map((item, idx) => {
                                        if (typeof item === "string") {
                                            return (_jsxs("div", { className: "flex items-start gap-3 text-sm text-slate-700", children: [_jsx("span", { className: "text-emerald-600 font-bold", children: "\u2192" }), _jsx("span", { children: item })] }, idx));
                                        }
                                        // Subtasks rendering
                                        return (_jsxs("div", { className: "mb-2", children: [_jsxs("div", { className: "flex items-start gap-3 text-sm text-slate-700 font-semibold", children: [_jsx("span", { className: "text-emerald-600 font-bold", children: "\u2192" }), _jsx("span", { children: item.title })] }), _jsx("ul", { className: "ml-7 mt-1 space-y-1", children: item.subtasks.map((sub, subIdx) => (_jsxs("li", { className: "flex items-center gap-2 text-xs text-slate-600", children: [_jsx("span", { className: "inline-block w-2 h-2 rounded-full bg-gray-300" }), _jsx("span", { children: sub.label })] }, subIdx))) })] }, idx));
                                    }) }))] }, phase.id))) }), _jsxs("div", { className: "space-y-4 pt-4", children: [_jsx("h3", { className: "font-bold text-lg text-slate-800", children: t('roadmap.thematic_deep_dive', "Thematische Verdieping") }), roadmapExpansions.map((expansion, index) => (_jsxs("div", { className: "bg-slate-50 border border-slate-200 rounded-lg p-5", children: [_jsx("h4", { className: "font-bold text-slate-900 mb-3", children: expansion.title }), _jsx("ul", { className: "space-y-2", children: expansion.items.map((item, idx) => (_jsxs("li", { className: "text-sm text-slate-600 flex items-start gap-2", children: [_jsx("span", { className: "text-blue-500 mt-1", children: "\u2022" }), _jsx("span", { children: item })] }, idx))) })] }, index)))] }), _jsxs("div", { className: "border-t pt-8", children: [_jsx("h3", { className: "font-bold mb-4", children: t('roadmap.submit_ideas', "💡 Ideeën indienen") }), _jsxs("div", { className: "flex gap-2", children: [_jsx("input", { type: "text", placeholder: t('roadmap.add_idea_placeholder', "Voeg idee in..."), value: newIdea, onChange: (e) => setNewIdea(e.target.value), onKeyPress: (e) => e.key === "Enter" && handleSubmitIdea(), className: "flex-1 border border-slate-300 rounded px-4 py-2 text-sm" }), _jsx("button", { onClick: handleSubmitIdea, className: "bg-blue-600 text-white px-4 py-2 rounded font-bold flex items-center gap-2", children: _jsx(Send, { size: 16 }) })] })] })] })), activeTab === "pilot" && (_jsxs("div", { className: "space-y-6 animate-in fade-in", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold text-slate-900 mb-2", children: "Optimalisatieplan: Fittings Pilot" }), _jsx("p", { className: "text-slate-600", children: "Technische en functionele optimalisaties voor de 4-weekse pilot." })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [_jsxs("div", { className: "bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col h-[600px]", children: [_jsxs("div", { className: "flex items-center justify-between mb-4 shrink-0", children: [_jsxs("h3", { className: "font-bold flex items-center gap-2 text-slate-800", children: [_jsx(FileText, { size: 20, className: "text-blue-500" }), " Plan Document"] }), _jsxs("button", { className: "text-xs bg-blue-50 text-blue-600 px-3 py-1.5 rounded-lg font-bold hover:bg-blue-100 flex items-center gap-1 transition-colors", children: [_jsx(Save, { size: 14 }), " Opslaan"] })] }), _jsx("textarea", { value: planContent, onChange: (e) => setPlanContent(e.target.value), className: "w-full flex-1 p-4 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none font-mono resize-none bg-slate-50" })] }), _jsxs("div", { className: "bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col h-[600px]", children: [_jsxs("h3", { className: "font-bold flex items-center gap-2 mb-4 shrink-0 text-slate-800", children: [_jsx(ListChecks, { size: 20, className: "text-emerald-500" }), " Actiepunten"] }), _jsx("div", { className: "space-y-2 overflow-y-auto custom-scrollbar pr-2 flex-1", children: pilotTasks.map(task => (_jsxs("div", { className: "flex items-start gap-3 p-3 hover:bg-slate-50 rounded-lg transition-colors cursor-pointer border border-transparent hover:border-slate-100", onClick: () => toggleTask(task.id), children: [_jsx("div", { className: `mt-0.5 w-5 h-5 rounded border flex items-center justify-center flex-shrink-0 transition-all ${task.completed ? "bg-emerald-500 border-emerald-500" : "border-slate-300 bg-white"}`, children: task.completed && _jsx(CheckCircle2, { size: 14, className: "text-white" }) }), _jsx("span", { className: `text-sm leading-relaxed ${task.completed ? "text-slate-400 line-through" : "text-slate-700 font-medium"}`, children: task.text })] }, task.id))) }), _jsxs("div", { className: "mt-4 pt-4 border-t border-slate-100 text-xs text-slate-400 text-center", children: [pilotTasks.filter(t => t.completed).length, " van ", pilotTasks.length, " taken voltooid"] })] })] })] }))] }));
};
