...
import { CheckCircle2, AlertTriangle, Clock, Zap, XCircle, Timer, ShieldCheck, PlayCircle, PauseCircle, ArrowRight, } from "lucide-react";
/**
...
const StatusBadge = React.memo(({ status, showIcon = true }) => {
    ...
    const getStatusConfig = (s) => {
        ...
        if (cleanStatus === "in production" ||
            ...
            return {
                ...
                icon: _jsx(Zap, { size: 12, fill: "currentColor" }),
            };
        }
        ...
        if (cleanStatus === "problem") {
            return {
                ...
                icon: _jsx(AlertTriangle, { size: 12 }),
            };
        }
    ...
    return (_jsxs("div", { className: `
        ...
        ${config.style}
      `, children: [showIcon && config.icon, _jsx("span", { className: "leading-none", children: config.label })] }));
});
