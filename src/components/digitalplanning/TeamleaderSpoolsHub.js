...
const TeamleaderSpoolsHub = React.memo((props) => {
    ...
    useEffect(() => {
        ...
        const unsubscribe = onSnapshot(docRef, (docSnap) => {
            ...
            if (docSnap.exists()) {
                ...
                const myDept = (data.departments || []).find((d) => d.slug === "spools" || d.id === "spools");
                if (myDept) {
    ...
    return (_jsx(TeamleaderHub, { ...props, fixedScope: "spools", departmentName: t('teamleader.spools_productions', 'Spools Producties'), allowedMachines: machineIds }));
});
