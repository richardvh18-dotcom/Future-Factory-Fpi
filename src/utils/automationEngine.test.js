...
import { evaluateCapacityShortage, evaluateLowEfficiency, evaluateOrderDelay, evaluateMissingOperator, evaluateDependencyBlocked, evaluateInspectionOverdue, evaluateRule, checkDebounce, executeRuleWithLogging, } from "./automationEngine";
...
const mockedExecuteAutomationRule = vi.mocked(executeAutomationRule);
