...
export const calculateAvailability = (operatingTimeMinutes, plannedBusyTimeMinutes) => {
    if (!plannedBusyTimeMinutes || plannedBusyTimeMinutes === 0)
        return 0;
...
export const getEfficiencyColor = (efficiency) => {
    if (efficiency >= 100)
        return "text-emerald-600 bg-emerald-50 border-emerald-200"; // Excellent
    if (efficiency >= 85)
        return "text-green-600 bg-green-50 border-green-200"; // Good
    if (efficiency >= 70)
        return "text-yellow-600 bg-yellow-50 border-yellow-200"; // Average
    if (efficiency >= 50)
        return "text-orange-600 bg-orange-50 border-orange-200"; // Poor
...
export const getEfficiencyLabel = (efficiency) => {
    if (efficiency >= 100)
        return i18n.t("efficiency.excellent", "Uitstekend");
    if (efficiency >= 85)
        return i18n.t("efficiency.good", "Goed");
    if (efficiency >= 70)
        return i18n.t("efficiency.average", "Voldoende");
    if (efficiency >= 50)
        return i18n.t("efficiency.poor", "Matig");
