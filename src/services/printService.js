...
export const queuePrintJob = async (printerId, zplData, metadata = {}) => {
    try {
        ...
        await logActivity(currentUserId, "PRINT_QUEUE_ADD", `Printjob in wachtrij gezet: ${docRef.id} (${printerId})`);
 ...
 */
export const getPrinterIdForStation = (stationId, printerMapping = {}) => {
